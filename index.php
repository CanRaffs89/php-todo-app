                ...
                <div class="card z-depth-3 card-wrapper">
                    <div class="card-content">
                        <ul class="collection with-header">
                            ...
                            <li class="collection-item"><h6 class="list-item">Item 2<a href="#!" class="secondary-content"><i class="material-icons">cancel</i></a></h6></li>
                            </li>
                            <li class="collection-item"><h6 class="list-item">Item 3<a href="#!" class="secondary-content"><i class="material-icons">cancel</i></a></h6></li>
                            </li>
                        </ul>
                    </div>
                </div>
